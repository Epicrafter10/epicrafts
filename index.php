            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Epicrafts</h1>
	                        <P class="hero-paragraph">Commandez vos sites et vos vos logos ici.</p>
                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            <h2 class="section-title mt-0">Payant</h2>
                            <p class="section-paragraph mb-0">Voici l'option payante que je vous offre.</p>
                        </div>
                                ...
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header pb-24">
                                            <div class="pricing-table-price"><span class="pricing-table-price-currency h2"></span><span class="pricing-table-price-amount h1">Standart: 15$</span><span class="text-xs"></span></div>
                                        </div>
                                        ...
                                        <ul class="pricing-table-features list-reset text-xs">
                                            ...
                                            <li>
                                                <span>Livraison: 5 jour</span>
                                            </li>
                                            <li>
                                                <span>Pages responsives</span>
                                            </li>
											<!--<li>
                                    ...
                                    <div class="pricing-table-cta mb-8">
                                        <a class="button button-primary button-shadow button-block" href="https://discord.gg/U3QmC2D" target="blank">Commander</a>
                                    </div>
                                </div>
                            </div>
                        </div>
			...
			<section class="cta section">
				<div class="container">
					<div class="cta-inner section-inner">
						<h3 class="section-title mt-0">Contactez moi</h3>
						<div class="cta-cta">
							<a class="button button-primary button-wide-mobile" href="contact-me.php">Cliquez ici</a>
						</div>
					</div>
				</div>
			</section>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2020 Epicrafts, tous droits réservés</div>
                </div>
            </div>
        </footer>
    </div>
